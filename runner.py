...
class HtmlApp:
    ...
    def __init__(self):
        ...
        self.ejemplos_norm = [
        # Pérez María 
        ("Incremento de cruceros en Ushuaia amenaza ecosistema costero", "  pérez maría   ",
        ...
        ("Proyección del crecimiento inmobiliario en Río Grande", "  pérez maría   ",
        ...
        ("Debate sobre el costo de vida en la provincia", "  pérez maría   ",
        ...
        ("Innovaciones locales en energías renovables en TDF", "  pérez maría   ",
        ...
        # Ramírez Carlos 
        ("Festival de la centolla atrae a turistas de todo el país", "ramirez carlos ",
        ...
        ("Nuevos senderos eco-turísticos inaugurados en Tolhuin", "ramirez carlos ",
        ...
        ("Plan de renovación urbana en Ushuaia recibe fondos nacionales", "ramirez carlos ",
        ...
        ("Inversión privada impulsa proyectos tecnológicos en TDF", "ramirez carlos ",
        ...
        # Ana López
        ("Aumento de tarifas del transporte en la ruta 3 genera protestas", " lópez ana  ",
        ...
        ("Descubrimiento arqueológico sacude a la comunidad yagana", " lópez ana  ",
        ...
        ("", "Pérez María ", "Título faltante para validar filtro."),
